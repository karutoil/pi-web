...
export function AgentErrorToast({ errors, onDismiss, onClearAll }: AgentErrorToastProps) {
            ...
            return (
              ...
              >
                ...
                <div className="conversation-extension-toast-copy">
                  <span className="conversation-extension-toast-title">Agent error</span>
                  <span className="conversation-extension-toast-message" title={err}>
                    {err}
                  </span>
                </div>
                <button
