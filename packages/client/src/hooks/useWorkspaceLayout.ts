...
const PANEL_IDS: WorkspacePanelKind[] = ["channels", "chat", "terminal", "preview", "git", "files", "extensions", "skills", "subagents", "rail"];
...
const DEFAULT_PANELS: WorkspaceLayout["panels"] = [
  ...
  { id: "subagents", region: "right", order: 5, size: 100 },
];
